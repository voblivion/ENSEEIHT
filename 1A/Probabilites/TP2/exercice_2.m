...
% Calcul du taux de compression obtenu par codage de Huffman :
% A DECOMMENTER/COMPLETER
nb_bits_sans_compression = 8*sum(histogramme);
taux_de_compression_avant_decorrelation = nb_bits_sans_compression/nb_bits_codage_Huffman_image_initiale;
disp(['Taux de compression avant decorrelation : ' num2str(taux_de_compression_avant_decorrelation)]);
...
% Calcul du taux de compression obtenu par decorrelation et codage de Huffman :
% A DECOMMENTER/COMPLETER
nb_bits_sans_compression = 8*sum(histogramme_decorrele);
taux_de_compression_apres_decorrelation = nb_bits_sans_compression/nb_bits_codage_Huffman_image_decorrelee;
disp(['Taux de compression apres decorrelation : ' num2str(taux_de_compression_apres_decorrelation)]);

disp(['Gain en compression : ' num2str(taux_de_compression_apres_decorrelation/taux_de_compression_avant_decorrelation)]);
