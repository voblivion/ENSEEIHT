...
public class EditeurLigne {
	...
	Menu menuSecondaire = new Menu("Fonctions que j'ai créé");
	menuSecondaire.ajouter("Remettre le curseur au début de la ligne",
		    new CommandeCurseurRaz(ligne));
	menuSecondaire.ajouter("Supprimer le caractère sous le curseur",
		    new CommandeCurseurSupprimer(ligne));
	menuPrincipal.ajouterSousMenu("Fonctions que j'ai créé", menuSecondaire, ligne, false);
