...
public class Menu  {
    ...
    /** Ajouter un sous-menu dans le menu.
     * @param texte l'intitulé dans le menu
     * @param m le menu associé
     * @param u si menu à usage unique
     */
    //@ requires texte != null && texte.length() > 0; // texte défini
    //@ requires cmd != null;		// commande définie
    public void ajouterSousMenu(String texte, Menu m, Ligne l, boolean u) {
	this.entrees.add(new Entree(texte, new CommandeMenu(m, l, u)));
    }
