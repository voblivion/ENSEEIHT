...
ecarts_angulaires_D_YX_1 = zeros(nb_essais,nb_valeurs_donnees_aberrantes);
ecarts_angulaires_D_YX_2 = zeros(nb_essais,nb_valeurs_donnees_aberrantes);
...
moyennes_ecarts_angulaires_D_YX_1 = mean(ecarts_angulaires_D_YX_1)/pi*180;
moyennes_ecarts_angulaires_D_perp_1 = mean(ecarts_angulaires_D_perp_1)/pi*180;
moyennes_ecarts_angulaires_D_YX_2 = mean(ecarts_angulaires_D_YX_2)/pi*180;
...
plot(100*valeurs_donnees_aberrantes/nb_donnees,moyennes_ecarts_angulaires_D_YX_1,'r-','LineWidth',2);
plot(100*valeurs_donnees_aberrantes/nb_donnees,moyennes_ecarts_angulaires_D_perp_1,'g-','LineWidth',2);
plot(100*valeurs_donnees_aberrantes/nb_donnees,moyennes_ecarts_angulaires_D_YX_2,'r-.','LineWidth',2);
plot(100*valeurs_donnees_aberrantes/nb_donnees,moyennes_ecarts_angulaires_D_perp_2,'g-.','LineWidth',2);
