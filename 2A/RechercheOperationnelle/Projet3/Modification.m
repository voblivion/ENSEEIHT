...
%%
%Mise à jour de la population (Insertion des fils)
...
for i=1:nb_mut
% sélection alétoire d'un individu
...
%% MAJ de la population Elimination des mauvais élements
% EVALUATION DE LA nouvelle POPULATION
[Eval,tab_sol,sigmaMoy,sigmaMin,W_Elu,indice_elu,Wfitness]= Evaluation(im,r,niter,coefs,weight,knots,subdiv1,cseuil);
disp('  Evaluation population modifiée pour la MAJ..');
for i=1:sizePop
    elt=tab_sol(1,i);
