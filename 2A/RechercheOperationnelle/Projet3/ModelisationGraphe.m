...
if ~som_trouve
    ...
    return;
end % on est sûr que le pixel de depart est un sommet du graphe, son numero est ini

% Calcul des largeurs minimales de tous les tronçons du graphe.
epaisseur; % epais{i}(k) contient la largeur minimale du tronçon (i, graphe{i}(k))
