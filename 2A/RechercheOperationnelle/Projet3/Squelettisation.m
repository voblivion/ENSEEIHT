...
% On est maintenant sûr que (idep,jdep) appartient au squelette
etat = im(idep,jdep);
switch etat
    case {0,1}
        ...
        % On l'ajoute à la liste des carrefours
        nbrecar = nbrecar + 1;
        icar(nbrecar) = idep;
        jcar(nbrecar) = jdep;
        %
...
% On est maintenant sûr que (idep,jdep) appartient au squelette
% On est maintenant sûr que (idep,jdep):
...
% On est maintenant sûr que (iarr,jarr) appartient au squelette
etat = im(iarr,jarr);
switch etat
    case {0,1}
        % le pixel de depart fait partie du squelette
...
% On est maintenant sûr que (iarr,jarr) appartient au squelette
% On est maintenant sûr que (iarr,jarr)
