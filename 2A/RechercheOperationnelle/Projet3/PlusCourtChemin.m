...
% on est sûr que le pixel d'arrivee est un sommet du graphe, son numero est but

if V(1,but) == Inf
    disp('Le point d''arrivee est inatteignable à partir du point de depart');
    return
end

cheminopt; % calcul du plus court chemin de ini à  but

chemin % affichage des numéros des sommets du chemin trouvé
