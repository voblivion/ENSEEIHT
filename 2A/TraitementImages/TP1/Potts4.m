function score = Potts4(T_0, q_max, alpha, beta)
global f1;
global f2;
...
%     figure(f1);
% else
%     f1 = figure('Name','Image a segmenter','Position',[0,0,0.33*L,0.3*L]);
% end
% imagesc(I);
% axis equal;
% axis off;
...
%     figure(f2);
% else
%     f2 = figure('Name',['Segmentation en ' num2str(N) ' regions'],'Position',[0.33*L,0,0.33*L,0.3*L]);
% end
% imagesc(couleurs_classes);
% axis equal;
% axis off;
% pause(temps_affichage*5);
