...
x_min = floor(min([F_1(1),F_2(1),F_1_estime(1),F_2_estime(1)])-a_max);
x_max = ceil(max([F_1(1),F_2(1),F_1_estime(1),F_2_estime(1)])+a_max);
y_min = floor(min([F_1(2),F_2(2),F_1_estime(2),F_2_estime(2)])-a_max);
y_max = ceil(max([F_1(2),F_2(2),F_1_estime(2),F_2_estime(2)])+a_max);
