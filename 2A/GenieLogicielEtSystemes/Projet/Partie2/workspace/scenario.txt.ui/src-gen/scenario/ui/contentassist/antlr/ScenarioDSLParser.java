		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDivergenceAccess().getGroup_3(), "rule__Divergence__Group_3__0");
					put(grammarAccess.getDivergenceAccess().getGroup_7(), "rule__Divergence__Group_7__0");
					...
					put(grammarAccess.getScheduleAccess().getComponentsAssignment_3(), "rule__Schedule__ComponentsAssignment_3");
					put(grammarAccess.getScheduleAccess().getComponentsAssignment_4_1(), "rule__Schedule__ComponentsAssignment_4_1");
					put(grammarAccess.getActivityAccess().getNameAssignment_2(), "rule__Activity__NameAssignment_2");
					put(grammarAccess.getActivityAccess().getNextAssignment_3_1(), "rule__Activity__NextAssignment_3_1");
					put(grammarAccess.getActivityAccess().getScheduleAssignment_4(), "rule__Activity__ScheduleAssignment_4");
					put(grammarAccess.getDivergenceAccess().getTypeAssignment_2(), "rule__Divergence__TypeAssignment_2");
					put(grammarAccess.getDivergenceAccess().getNextAssignment_3_1(), "rule__Divergence__NextAssignment_3_1");
					put(grammarAccess.getDivergenceAccess().getSchedulesAssignment_6(), "rule__Divergence__SchedulesAssignment_6");
					put(grammarAccess.getDivergenceAccess().getSchedulesAssignment_7_1(), "rule__Divergence__SchedulesAssignment_7_1");
				}
			};
		}
