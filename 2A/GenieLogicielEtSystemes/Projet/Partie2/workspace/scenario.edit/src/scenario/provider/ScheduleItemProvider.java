...
/**
 * This is the item provider adapter for a {@link scenario.Schedule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduleItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioPackage.Literals.SCHEDULE__COMPONENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Schedule.class)) {
			case ScenarioPackage.SCHEDULE__COMPONENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCHEDULE__COMPONENTS,
				 ScenarioFactory.eINSTANCE.createActivity()));

		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCHEDULE__COMPONENTS,
				 ScenarioFactory.eINSTANCE.createDivergence()));
	}
