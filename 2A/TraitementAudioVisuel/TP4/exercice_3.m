...
% Moindres carres totaux (contraintes ||X|| = 1) :
A = ones(n, 6);
A(:,1) = Pd(:,1).^2;
A(:,2) = Pd(:,1).*Pd(:,2);
A(:,3) = Pd(:,2).^2;
...
R_3 = [cos(theta_0_3) -sin(theta_0_3) ; sin(theta_0_3) cos(theta_0_3)];
c_3 = sqrt(a_3*a_3-b_3*b_3);
F_1_3 = R_3*[c_3 ; 0]+C_3;
F_2_3 = R_3*[-c_3 ; 0]+C_3;
disp(['Score 3 = ' num2str(score(F_1,F_2,a,F_1_3,F_2_3,a_3),'%.3f')]);
